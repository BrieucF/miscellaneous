...
{ 
    ...
    AddHisto("track_nHitStrip"   ,      "number of hits in the Strip",                 27,-0.5, 26.5  );
    AddHisto("track_nHitTIB"   ,      "number of hits in the TIB",                 12,-0.5, 11.5  );
    AddHisto("track_nHitTID"   ,      "number of hits in the TID",                 10,-0.5, 9.5  );
    AddHisto("track_nHitTOB"   ,      "number of hits in the TOB",                 16,-0.5, 15.5  );
    AddHisto("track_nHitTEC"   ,      "number of hits in the TEC",                 21,-0.5, 20.5  );
    AddHisto("track_nHitPXB"   ,      "number of hits in the PXB",                 7,-0.5, 6.5  );
    AddHisto("track_nHitPXF"   ,      "number of hits in the PXF",                 7,-0.5, 6.5  );
