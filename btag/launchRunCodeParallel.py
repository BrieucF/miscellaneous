...
################
#  You changed trigger in CommPlotProducer !!!
###############
...
outRootFileDir = "/home/fynu/bfrancois/bTag/CMSSW_7_4_5/src/RecoBTag/PerformanceMeasurements/test/BTagAnalyzerMacros/runIISpring16AODSIM_v1_resubmit3_full_"+str(ptTrig)+"_Plot"+str(jetPtMin)+"_"+str(jetPtMax)+'_pthat_15_470_PUrew/'
...
if not isMuEn :
    ...
    if fullStat : 
        fileList = {
                ...
                "data_JetHT_2016B_804_run_271036-273450" : ["/storage/data/cms/store/user/brfranco/bTag/2016_271036-273730/JetHT/crab_JetHT_2016-05-31_1464688162068/160531_094959/0000/JetTree_data_INDEX.root", 249],
                #"data_JetHT_2015D_16Dec2015_763" : ["root://eoscms.cern.ch//eos/cms/store/group/phys_btag/performance/CMSSW_7_6_3/Data/JetHT/Run2015D-16Dec2015-v1/JetTree_data_FatJets_Subjets_INDEX.root", 986]
#                "data_JetHT_2015D_prompt_256630-257599" : ["root://eoscms.cern.ch//eos/cms/store/group/phys_btag/Commissioning/CMSSW_7_4_8/Data/JetHT/Run2015D_PromptReco_256630-257599/JetTree_data_*", 0]
...
for ptBin in fileList.keys() :
    print ptBin
    for index in xrange(1, fileList[ptBin][1]+1):
        ...
        f.write('root -b -q /home/fynu/bfrancois/bTag/CMSSW_7_4_5/src/RecoBTag/PerformanceMeasurements/test/BTagAnalyzerMacros/runCode_parallel.C\(\\\"'+charForChain+'\\\",0,\\\"'+outRootFileDir+"/"+ptBin+"_"+str(index)+'\\\",'+str(isMuEn)+','+str(ptTrig)+','+str(jetPtMin)+','+str(jetPtMax)+',\\\"'+PUreweightingFile+'\\\"\)')
        f.close()
