...
//TString dir4plots="plots_7414_25ns_pthat80_600_PFjet200_Jet220_500_PUReweighted_"+PU;
//TString dir4plots="plots_QCDinc_748_25ns_ptHat15to600_Trig40_Plot50_250_PUrew_"+PU+"_nHitSub";
//TString filename = "QCDinc_748_25ns_ptHat15to600_Trig40_Plot50_250_PUrew_withData2015D_256630_256869_nHitSub_TenPercent/allHadded.root";
//TString filename = "QCDinc_7414_25ns_ptHat15to470_Trig40_Plot50_250_PUrew_withData2015D_256630_258750_fullStat/hadded.root";
//TString filename = "QCDinc_7414_25ns_ptHat15to470_Trig40_Plot50_250_approxPUrew_withData2015D_2dot11fb_fullStat/hadded.root";
//TString filename = "QCDinc_7414_25ns_ptHat80to600_Trig200_Plot220_500_PUrew_withData2015D_256630_258750_fullStat//hadded.root";
//TString filename = "QCDinc_7414_25ns_ptHat15to470_Trig40_Plot50_250_noPUrew_withData2015D_256630_258750_fullStat/hadded.root";
///TString dir4plots="plots_748_25ns_pthat15_600_PFjet40_Jet50_250_PUReweighted_"+PU+"_nHitSub";
//TString filename = "QCDinc_748_25ns_ptHat15to600_Trig40_Plot50_250_PUrew_withData2015D_256630_256869_nHitSub_TenPercent/allHadded.root";
//TString filename = "QCDinc_748_25ns_ptHat15to600_Trig40_Plot50_250_PUrew_withData2015D_256630_256869/hadded_JetHT2015D_256630-256869_pthat30to470_PFJet40.root";
//TString filename = "QCDinc_748_25ns_ptHat15to600_Trig40_Plot50_250_noPUrew/hadded_JetHT2015D_256630-256869_pthat30to470_PFJet40.root";
//TString filename = "QCDinc_748_25ns_ptHat15to600_Trig40_Plot50_250_noPUrew/hadded_Pt15To470_JetHT.root";  
//TString dir4plots = "plots_748_25ns_pthat80_600_PFjet200_Jet220_500_PUReweighted_"+PU; 
//TString filename = "QCDinc_748_25ns_ptHat15to600_Trig200_Plot220_500_PUrew_withData2015D_256630_256869/hadded_JetHT2015D_256630-256869_pthat80to600_PFJet200.root";  //"QCDinc_748_25ns_ptHat15to600_Trig200_Plot220_500_noPUrew/hadded_Pt120To600_JetHT.root";  
bool btag = false;   // if we are in DiMu --> true

//TString dir4plots="no127_plots_DiJet20_Jet60_250_"+PU+"PUReweighted_goldenJSON_goodFlavSplit_newJPCalib_fullLumi"; 
//TString jettype = "PFJet40, jet pT>60";
//TString filename = "50nsTuples/DiJet20_Plot60_250_PUreweightedNotIdentical_ptBin20to300.root"; //"muEnQCD_ptBin20to300_star1_TrigDijet20_Jet60_250_"+PU+"PUReweighted_goldenJSON/muEnQCD_ptBin20to300_star1_TrigDijet20_Jet60_250_"+PU+"PUReweighted_goldenJSON.root"; 
...
/*
    hist_c     ->SetLineColor(8);
    hist_b     ->SetLineColor(kRed);
    hist_bfromg->SetLineColor(7);  //Pour merger les contributions --> kRed
    hist_l     ->SetLineColor(kBlue);
    hist_g     ->SetLineColor(kBlue);
    hist_cfromg     ->SetLineColor(8);
    hist_puu     ->SetLineColor(kYellow);
*/
...
//    TPad* canvas_1 = new TPad("canvas"+name, "canvas"+name,0,0.25,1.0,0.98);
...
//end Devdatta
    canvas_1 ->cd();
/* us
    TLatex *   tex = new TLatex(0.98,0.95125,"40.9 pb^{-1} (13 TeV)");
    tex->SetNDC();
    tex->SetTextAlign(31);
    tex->SetTextFont(42);
...
/*
    if (name=="trk_multi_sel") {
      stack->GetHistogram()->GetXaxis()->SetRange(1,imax);
    }
*/
// us
...
/*
    if (name=="trk_multi_sel") {
      cout << " data " <<  hist_data->GetBinContent(imax) << " " << hist_data->GetBinError(imax) << endl;
      cout << " MC " << histo_tot->GetBinContent(imax) << " " << histo_tot->GetBinError(imax) << endl;
      cout << " ratio " << histo_ratio->GetBinContent(imax) << " " << histo_ratio->GetBinError(imax) << endl;
    }
*/
...
*/
  ...
  // Devdatta
  qw = new TLegend(0.65,0.55,0.95,0.90,NULL,"brNDC");
  // end Devdatta
...
//    qw->AddEntry(hist_data,     datacaption,                       "pl");
    ...
    qw->AddEntry(hist_b,        "b"           ,         "f");
    qw->AddEntry(hist_c,        "c"           ,         "f");
  //  qw->AddEntry(hist_cfromg,   "c from g split"           ,         "f");
    qw->AddEntry(hist_l,        "udsg"     ,    "f");
...
*/
   ...
   TString sample = "";
/*
    if (filename.Contains("PFJet")) sample += "Multijets" ;
    else if (filename.Contains("DiJet")) sample += "Muon enriched QCD" ;

     if (filename.Contains("JetHT") || filename.Contains("QCDinc")) sample += "Multijets" ;
     else if (filename.Contains("DiJet")) sample += "Muon enriched QCD" ;
*/
     sample += "Multijets" ;
   ...
   // end Devdatta
    ...
    histo_ratio->GetYaxis()->SetTitle("#bf{Data/MC}");
...
/*
    TString name_plot2=name+"_Linear.eps";
    if(log) name_plot2=name+"_Log.eps";
    c1->SaveAs(dir4plots+"/"+name_plot2);
    TString name_plot3=name+"_Linear.png";
    if(log) name_plot3=name+"_Log.png";
...
void DrawTagRate(TString name, TString histotitle, bool log){
    ...
    qw->AddEntry(TagRate_MC_b,        "b"                  ,"f");
    qw->AddEntry(TagRate_MC_gspl,     "b from gluon splitting"   ,"f");
    qw->AddEntry(TagRate_MC_c,        "c"                  ,"f");
    qw->AddEntry(TagRate_MC_udsg,     "udsg"     ,"f");
...
void Draw2DPlot(TString name, TString histotitle, TString titleX, TString titleY, bool log){
    ...
    qw->AddEntry(pro_mc_b,        "b"                ,"l");
    qw->AddEntry(pro_mc_gspl,     "b from gluon splitting" ,"l");
    qw->AddEntry(pro_mc_c,        "c"                ,"l");
    qw->AddEntry(pro_mc_udsg,     "udsg"     ,"l");
